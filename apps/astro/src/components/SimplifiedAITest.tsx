...
export function SimplifiedAITest() {
	...
	const handleAnalysis = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			// Test the Astro action directly
	...
	return (
		<div className="simplified-ai-test">
			<div className="test-header">
				<h1>Tech Radar AI Assistant</h1>
				<p>Test your OpenRouter + Mastra integration</p>
				<div className="status-indicators">
					<div className="status-item">
						<span className="status-dot openrouter" />
						OpenRouter Integration
					</div>
					<div className="status-item">
						<span className="status-dot mastra" />
						Mastra Agent
					</div>
				</div>
			</div>
			...
			{error && (
				<div className="error-message">
					...
					<details>
						...
						<ul>
							<li>Make sure your OpenRouter API key is set in <code>.env</code></li>
							<li>Verify Mastra server is running on port 4111</li>
...
export default SimplifiedAITest;