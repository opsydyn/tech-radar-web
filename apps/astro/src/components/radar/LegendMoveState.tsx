...
export const LegendMoveState = () => {
  const effectiveTheme = getEffectiveTheme();
  const textColor = effectiveTheme === 'dark' || effectiveTheme === 'machine' ? '#fff' : '#333333';
  
  return (
    <LegendBase title="Movement">
      <LegendItem style={{ color: textColor, fontFamily: 'IBM Plex Mono, monospace' }}>
        ...
        <LegendLabel align="left" margin="0 0 0 4px" style={{ color: textColor, fontFamily: 'IBM Plex Mono, monospace' }}>
          Moved in
        </LegendLabel>
      </LegendItem>
      <LegendItem style={{ color: textColor }}>
        ...
        <LegendLabel align="left" margin="0 0 0 4px" style={{ color: textColor, }}>
          Moved out
        </LegendLabel>
      </LegendItem>
    </LegendBase>
...
export default LegendMoveState;
