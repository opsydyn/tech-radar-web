...
export const BlipListIsland: React.FC<BlipListIslandProps> = ({ blips, quadrant, quadrantColor }) => {
  ...
  useEffect(() => {
    if (filteredBlips.length > 0 && (!selected || !filteredBlips.some(blip => blip.name === selected.name))) {
  ...
  return (
    <div className={styles.container} style={{
      ...
      <a href="/" className={styles.homeLink}>
        <span aria-hidden="true" className={styles.arrowIcon}>⬅</span> Home
      </a>
